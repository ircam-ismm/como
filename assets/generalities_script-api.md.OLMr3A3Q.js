import{V as e,et as t,mt as n,tt as r}from"./chunks/framework.DKmNYlsm.js";var i=JSON.parse(`{"title":"Scripts API","description":"","frontmatter":{},"headers":[],"relativePath":"generalities/script-api.md","filePath":"generalities/script-api.md"}`),a={name:`generalities/script-api.md`};function o(e,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[r(`<h1 id="scripts-api" tabindex="-1">Scripts API <a class="header-anchor" href="#scripts-api" aria-label="Permalink to “Scripts API”">​</a></h1><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai" style="background-color:#272822;color:#F8F8F2;" tabindex="0" dir="ltr"><code><span class="line"><span style="color:#88846F;">/**</span></span>
...
<span class="line"><span style="color:#66D9EF;font-style:italic;">  const</span><span style="color:#F8F8F2;"> { output, state, soundbank, scriptName } </span><span style="color:#F92672;">=</span><span style="color:#F8F8F2;"> context;</span></span>
<span class="line"><span style="color:#88846F;">  // ...</span></span>
<span class="line"><span style="color:#F8F8F2;">}</span></span></code></pre></div>`,2)]])}var s=e(a,[[`render`,o]]);export{i as __pageData,s as default};