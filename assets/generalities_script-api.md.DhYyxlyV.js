import{_ as n,o as a,c as l,ak as p}from"./chunks/framework.DuEQbpZW.js";const d=JSON.parse('{"title":"Scripts API","description":"","frontmatter":{},"headers":[],"relativePath":"generalities/script-api.md","filePath":"generalities/script-api.md"}'),o={name:"generalities/script-api.md"};function e(t,s,c,F,r,i){return a(),l("div",null,[...s[0]||(s[0]=[p(`<h1 id="scripts-api" tabindex="-1">Scripts API <a class="header-anchor" href="#scripts-api" aria-label="Permalink to “Scripts API”">​</a></h1><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki monokai" style="background-color:#272822;color:#F8F8F2;" tabindex="0" dir="ltr"><code><span class="line"><span style="color:#88846F;">/**</span></span>
