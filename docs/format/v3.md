...
This data format aims at providing a unified interface for motion sensors so that a
given application can work seamlessly with different motion sensors and devices.

The format tries to follow as much as possible the W3C specification.
